...
export function ClearScheduledTaskWorkerLogs():Promise<bridge.FlagResult>;

export function ClientEventsEmit(arg1:string,arg2:Array<any>):Promise<void>;
...
export function EventsOn(arg1:string,arg2:any):Promise<void>;
...
export function GetScheduledTaskWorkerLogs():Promise<bridge.FlagResult>;
...
export function RecordScheduledTaskLog(arg1:string):Promise<bridge.FlagResult>;

export function ReloadScheduledTaskWorker():Promise<bridge.FlagResult>;

export function RemoveFile(arg1:string):Promise<bridge.FlagResult>;

export function RequestHeadlessShutdown():Promise<void>;
...
export function StartScheduledTaskWorker():Promise<void>;

export function StartServer(arg1:string,arg2:string,arg3:bridge.ServerOptions):Promise<bridge.FlagResult>;

export function StopScheduledTaskWorker():Promise<void>;
