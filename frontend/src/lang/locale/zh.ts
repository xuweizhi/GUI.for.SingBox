export default {
  ...
  netCheck: {
    ...
    summary: {
      ...
      tcpFailed: 'TCP 连通失败',
      groupEmpty: '暂无检测项',
      groupAttention: '存在异常项',
      groupRunning: '检测进行中',
      groupSkipped: '本组已跳过',
      groupReady: '本组已完成',
      groupCountSuccess: '成功 {0} 项',
      groupCountFailed: '失败 {0} 项',
      groupCountSkipped: '跳过 {0} 项',
      groupCountRunning: '进行中 {0} 项',
      ipTarget: '目标是 IP，跳过 DNS 查询',
      dnsUnavailable: 'DNS 查询不可用',
      dnsFailed: 'DNS 查询失败',
      outboundUnavailable: '主出站状态不可用',
      outboundReady: '主出站已就绪',
      outboundFailed: '主出站检测失败',
      ruleMatchUnavailable: '规则命中信息不可用',
      ruleMatchFailed: '规则命中检测失败',
      rulesetsUnavailable: '规则集状态不可用',
      noRulesets: '未配置规则集',
      rulesetsFailed: '规则集检测失败',
    },
    node: {
      title: '节点诊断',
  ...
  home: {
    ...
    nodes: {
      ...
      urlTestReadonly: '当前组由 Sing-Box 自动选择，可以查看和测速，但不能手动切换。',
