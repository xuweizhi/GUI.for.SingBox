export default {
  ...
  netCheck: {
    ...
    results: {
      ...
      dnsQuery: 'DNS Query',
      outboundDelay: 'Primary Outbound Delay',
      latestRuleMatch: 'Latest Rule Match',
      rulesetItem: 'Ruleset',
    ...
    summary: {
      ...
      groupEmpty: 'No checks in this group',
      groupAttention: 'This group contains failures',
      groupRunning: 'Checks in this group are still running',
      groupSkipped: 'This group was skipped',
      groupReady: 'This group is complete',
      groupCountSuccess: '{0} succeeded',
      groupCountFailed: '{0} failed',
      groupCountSkipped: '{0} skipped',
      groupCountRunning: '{0} running',
      ipTarget: 'Target is an IP address, so DNS query was skipped',
      dnsUnavailable: 'DNS query is unavailable',
      dnsFailed: 'DNS query failed',
      outboundUnavailable: 'Primary outbound state is unavailable',
      outboundReady: 'Primary outbound is ready',
      outboundFailed: 'Primary outbound check failed',
      ruleMatchUnavailable: 'Rule match information is unavailable',
      ruleMatchFailed: 'Rule match check failed',
      rulesetsUnavailable: 'Ruleset state is unavailable',
      noRulesets: 'No rulesets are configured',
      rulesetsFailed: 'Ruleset check failed',
    },
    node: {
  ...
  home: {
    ...
    nodes: {
      ...
      urlTestReadonly:
        'This group is selected automatically by Sing-Box. Nodes can be viewed and tested, but not switched manually.',
